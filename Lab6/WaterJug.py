def solve_dfs(jug_sizes, target_volume, start_volumes):
    explored = set()
...
def get_successors(state, jug_sizes):
    ...
    successors.append((jug1_cap, jug2))  # Fill jug1
    successors.append((jug1, jug2_cap))  # Fill jug2
...
# ---- Custom Input ----
jug1_size = int(input("Enter size of jug 1: "))
jug2_size = int(input("Enter size of jug 2: "))
target = int(input("Enter target volume: "))

path = solve_dfs((jug1_size, jug2_size), target, (0, 0))
